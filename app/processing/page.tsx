  ...
  return (
    <div style={st.page}>
      ...
      <div style={st.main}>
        ...
        <div style={st.topbar}>
          <div>
            <div style={st.pageTitle}>Document Processing</div>
            <div style={st.pageSub}>Upload · Extract · Review · Confirm</div>
          </div>
...
const st: Record<string, React.CSSProperties> = {
  ...
  dragHint:   { fontSize: 10, color: "#cbd5e1", textAlign: "right" as const, userSelect: "none" as const },
};